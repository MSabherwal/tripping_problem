Tripping Intervew Question
---------------------------


link: http://codepen.io/tripping/recruiting/calendar_challenge
---------------------------------------------------------------



The following JSON provides information about a property:

    availability of the property for a day (N means booked, Y means vacant)
    the property's minimum stay requirement is how nights days the property must be booked for if the check-in date is that day (6 min-stay is 7 days)
    the property's price for each days booked

Please provide a solution which ingests the data and can fulfill the following requirements

    Return an array of available date ranges (only list start and ending of range)
    Given a series of days return whether available and if so the cost

{
  "start_date": "2015-01-01",
  "availability": "",
  "minstay":
